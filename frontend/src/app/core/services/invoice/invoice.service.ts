...
export class InvoiceService {
  ...
  generateInvoice(rent: RentModel) {
    const docDefinition = this.generateContent(rent);
    pdfMake.createPdf(docDefinition).open();
  }

  private generateContent(rent: RentModel) {
    console.log(rent);
    return {
      content: [
        // Header
                ...
                stack: [
                  ...
                  },
                  {
                    columns: [
                      ...
                      {
                        text: this.datePipe.transform(rent.invoice.createdAt, 'medium'),
                        style: 'invoiceSubValue',
                        width: 100
                      }
                    ]
        ...
        // Billing Address
        {
          columns: [
            {
              text: 'Jūsų įmonės banko sąskaita',
              style: 'invoiceBillingAddress'
            }
          ]
        },
          ...
          table: {
            ...
            body: [
              ...
              [
                [
                  {
                    text: `Automobilio ${rent.car.brand} ${rent.car.model} nuoma`,
                    style: 'itemTitle'
                  },
                  {
                    text: 'Pastabos',
                ...
                {
                  text: `${rent.startDate} - ${rent.endDate}`,
                  style: 'itemDate'
                },
                {
                  text: '0%',
